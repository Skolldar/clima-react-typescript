...
const WeatherSunTime = ({weather}: WeatherSunTimeProps) => {
  return (
    ...
    <div className="blur-card">
          <h2 className="font-semibold text-primary text-left pb-5">Sunset and Sunrise</h2>
          ...
          <div className="bg-white/50 shadow-md p-8 rounded-xl flex flex-col items-center">
              <div className="mb-4 flex justify-center">
                <img src="../sunrise.png" alt="Sunrise" className='w-35 h-35' />
              </div>
          ...
          <div className="bg-white/50 shadow-md p-8 rounded-xl flex flex-col items-center">
              <div className="mb-4 flex justify-center">
                <img src="../sunset.png" alt="Sunset" className='w-35 h-35' />
              </div>
              <div className="text-primary py-5 text-md font-normal">
